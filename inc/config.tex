...
%     + Define el ambiente {clicode} para comandos de CLI
\newminted{bash}{}
%     + Define el comando \clifile{path} para comandos de CLI desde archivos externos
\newmintedfile{bash}{}
%     + Define el ambiente {jsoncode} para código JSON
\newminted{json}{linenos}
%     + Define el comando \jsonfile{path} para código JSON desde archivos externos
\newmintedfile{json}{linenos}
%     + Define el ambiente {clicode} para comandos de CLI
