...
Uno de los 9 principios de diseño de \gls{acro:soa} que mencionamos antes es el bajo acoplamiento (\eng{loose coupling}) de los servicios, y una de las formas más comunes de implementarlo es mediante un \acrlong{acro:esb} o \gls{acro:esb}.
