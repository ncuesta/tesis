...
El patrón de microservicios trata estas cuestiones, separando la aplicación en múltiples unidades desplegables (los \eng{service components} antes mencionados), que pueden ser desarrolladas, testeadas y desplegadas independientemente de otros \eng{service components}\cite[p.~27]{richards2015}.
