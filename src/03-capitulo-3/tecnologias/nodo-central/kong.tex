...
Luego, procedemos a crear un \eng{consumer} (cliente) para asignar a esta \gls{acro:api} y le asignamos una clave para que pueda identificarse ante Kong.
