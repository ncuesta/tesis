...
TODO: Hablar de microservicios, de deployments separados, mantenimiento más fácil, desarrollo enfocado claramente en cada aplicación (API) y testeabilidad mejorada.
