...
El hecho de dividir la aplicación en componentes pequeños y \eng{deployables} de manera independiente, facilita el desarrollo y \eng{testing}, debido a que el cambio se encuentra aislado a un \eng{service component}.  Por lo tanto, hemos optado por seguir el patrón de arquitectura de microservicios para el diseño de la nube de servicios de la {\unlp}.
