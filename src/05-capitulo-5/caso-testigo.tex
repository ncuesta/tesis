...
\begin{itemize}
  ...
  \item Desarrollar una \textit{gema} (nombre que reciben las librerías reutilizables en el lenguaje Ruby) que encapsule la lógica de acceso a los servicios, desde la autenticación hasta la consulta y abstracción en objetos de las respuestas de sus \apis, basándose en el estándar elegido para la codificación de la información.
\end{itemize}
