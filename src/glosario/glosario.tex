...
\newglossaryentry{pattern:microservice} {
  name = {Microservicio},
  description = {patrón de Arquitectura de Software que separa la aplicación en unidades deployables, fáciles de testear y desarrollar.},
  sort = {microservice}
}
